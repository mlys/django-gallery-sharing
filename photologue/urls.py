...
urlpatterns = patterns('',
    ...
    url(r'^gallery/?$', galleries_index, name='pl-gallery-archive'),
)
urlpatterns += patterns('',
    url(r'^gallery/(?P<slug>[\-\d\w]+)/$',  show_gallery,  name='pl-gallery'),
    url(r'^gallery/page/(?P<page>[0-9]+)/$', all_galleries, name='pl-gallery-list'),
)
